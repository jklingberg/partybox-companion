...
Related: [ADR-033](033-speaker-standby-detection.md) (the auto-idle standby model this behavior is easily confused with, but is not), [ADR-032](032-capability-probing.md).
